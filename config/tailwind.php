...
return [
    // 'container_styles' => 'max-w-5xl mx-auto',
    'container_styles' => 'container mx-auto',

    'simple_btn_styles' => 'px-4 py-2 rounded-md transition hover:opacity-60 text-white',

    'general_input_styles' => 'w-full mb-3 py-2 px-3 rounded text-white bg-black',
